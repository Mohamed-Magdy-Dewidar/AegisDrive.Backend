...
//    // We assume the Python script/Pi adds these to the payload
...
//    public string DriverState { get; set; } = string.Empty; // "DROWSY"

//    [JsonPropertyName("alert_level")]
//    public string AlertLevel { get; set; } = string.Empty; // "CRITICAL"
